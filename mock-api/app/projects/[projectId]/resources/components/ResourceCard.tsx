    ...
    <>
      ...
      >
        ...
        <div className="mb-4 space-y-2">
          ...
          {[
            { method: "GET", path: `https://mockapi.io.vn/mock-api/${resource.projectId}${prefix}/${resource.name.toLowerCase()}`, apiKey },
            { method: "POST", path: `https://mockapi.io.vn/mock-api/${resource.projectId}${prefix}/${resource.name.toLowerCase()}`, apiKey },
            { method: "PUT", path: `https://mockapi.io.vn/mock-api/${resource.projectId}${prefix}/${resource.name.toLowerCase()}/:id`, apiKey },
            { method: "PATCH", path: `https://mockapi.io.vn/mock-api/${resource.projectId}${prefix}/${resource.name.toLowerCase()}/:id`, apiKey },
            { method: "DELETE", path: `https://mockapi.io.vn/mock-api/${resource.projectId}${prefix}/${resource.name.toLowerCase()}/:id`, apiKey },
          ].map((endpoint) => {
